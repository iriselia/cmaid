...
MACRO(cmaid_project)
	...
	if(${PROJECT_NAME}_INITIALIZED)
		project(${PROJECT_NAME} C ASM_MASM)
	else()
	...
	if( ${PROJECT_NAME}_INITIALIZED )
		...
		list(APPEND PROJECT_INCLUDE_DIRS ${GLOBAL_SOURCE_DIRECTORIES})
		...
		elseif(${PROJECT_CONFIGURATION} STREQUAL "KERNEL_DRIVER")
			include( scripts/FindWdk )
			wdk_add_driver (${PROJECT_NAME} ${PROJECT_SOURCE} ${PROJECT_HEADERS} ${${PROJECT_NAME}_SHADERS} ${${PROJECT_NAME}_MISC} ${${PROJECT_NAME}_RESOURCES})
			#add_executable (${PROJECT_NAME} ${PROJECT_SOURCE} ${PROJECT_HEADERS} ${${PROJECT_NAME}_SHADERS} ${${PROJECT_NAME}_MISC} ${${PROJECT_NAME}_RESOURCES})
			if(MSVC)
		...
		elseif(${PROJECT_CONFIGURATION} STREQUAL "KERNEL_STATIC")
			include( scripts/FindWdk )
			wdk_add_library (${PROJECT_NAME} STATIC ${PROJECT_SOURCE} ${PROJECT_HEADERS} ${${PROJECT_NAME}_SHADERS} ${${PROJECT_NAME}_MISC} ${${PROJECT_NAME}_RESOURCES})
			#add_executable (${PROJECT_NAME} ${PROJECT_SOURCE} ${PROJECT_HEADERS} ${${PROJECT_NAME}_SHADERS} ${${PROJECT_NAME}_MISC} ${${PROJECT_NAME}_RESOURCES})
		endif()
