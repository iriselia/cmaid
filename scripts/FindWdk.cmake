...
function(wdk_add_driver _target)
    ...
    if(DEFINED WDK_KMDF)
        ...
        if(CMAKE_SIZEOF_VOID_P EQUAL 4)
            set_property(TARGET ${PROJECT_NAME} APPEND_STRING PROPERTY LINK_FLAGS "/ENTRY:driver_entry@8")
        elseif(CMAKE_SIZEOF_VOID_P  EQUAL 8)
            set_property(TARGET ${PROJECT_NAME} APPEND_STRING PROPERTY LINK_FLAGS "/ENTRY:driver_entry")
        endif()
    else()
        if(CMAKE_SIZEOF_VOID_P EQUAL 4)
            set_property(TARGET ${PROJECT_NAME} APPEND_STRING PROPERTY LINK_FLAGS "/ENTRY:driver_entry@8")
